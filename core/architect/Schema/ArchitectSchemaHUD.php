...
function ArchitectSchemaHUDBodyCallback(){
  ...
  <p>
    <a class="btn btn-success" href="/architect/schema/add">Add Schema</a>
    <a class="btn btn-success" href="/architect/files/edit/?path=/schema.php">Edit Current Configuration</a>
