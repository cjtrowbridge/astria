      ...
      <div class="card">
        <div class="card-block">
          <div class="card-text">
            ...
            <a class="btn btn-success" target="_blank" href="<?php echo $Crawler['Protocol'].'://'.$Crawler['Domain'].'/'.$Crawler['Path'].'?'.$Crawler['QueryVariable1'].'='.$Query1Value.'&'.$Crawler['QueryVariable2'].'='.$Query2Value.'&'.$Crawler['RangeVariable'].'='.$Crawler['RangeMin'].'&dataset='.$Crawler['CrawlerDatasetID']; ?>">Test First Page Link</a>
