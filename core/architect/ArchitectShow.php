...
<div class="row">
  <div class="hidden" id="PullMainlineWebhook">
    <a target="_blank" href="<?php echo $ASTRIA['app']['appURL'].'/'.BlowfishEncrypt('Pull Mainline From Github'); ?>"><?php echo $ASTRIA['app']['appURL'].'/'.BlowfishEncrypt('Pull Mainline From Github'); ?></a>
  </div>
